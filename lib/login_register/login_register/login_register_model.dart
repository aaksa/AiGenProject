...
class LoginRegisterModel extends FlutterFlowModel<LoginRegisterWidget> {
  ...
  // Stores action output result for [Custom Action - linkedinLogIn] action in Button widget.
  dynamic? resulta;
  ...
  // Stores action output result for [Custom Action - loginLinkedin] action in Button widget.
  bool? result;
