...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'DashboardBanking',
          path: '/dashboardBanking',
          requireAuth: true,
          builder: (context, params) => DashboardBankingWidget(),
        ),
        FFRoute(
          name: 'mainquery',
          path: '/posts',
          requireAuth: true,
          builder: (context, params) => MainqueryWidget(
        ...
        FFRoute(
          ...
          path: '/webFlow041',
          requireAuth: true,
          builder: (context, params) => WebFlow041Widget(),
        ),
        FFRoute(
          name: 'webFlow_01_1',
          path: '/webFlow011',
          requireAuth: true,
          builder: (context, params) => WebFlow011Widget(),
        ),
        FFRoute(
          name: 'webFlow_02_1',
          path: '/webFlow021',
          requireAuth: true,
          builder: (context, params) => WebFlow021Widget(),
        ),
        FFRoute(
          name: 'webFlow_03_1',
          path: '/webFlow031',
          requireAuth: true,
          builder: (context, params) => WebFlow031Widget(),
        ),
        FFRoute(
          name: 'ForgotPassword',
          path: '/forgotPassword',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      'assets/images/ai_gen_launch_icon.png',
