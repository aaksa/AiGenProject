...
import 'side_nav1_model.dart';
export 'side_nav1_model.dart';

class SideNav1Widget extends StatefulWidget {
  const SideNav1Widget({
    super.key,
    int? selectedNav,
  ...
  @override
  State<SideNav1Widget> createState() => _SideNav1WidgetState();
}

class _SideNav1WidgetState extends State<SideNav1Widget> {
  late SideNav1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SideNav1Model());
